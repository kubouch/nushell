...
use nu_protocol::{
    ...
    span, Alias, BlockId, Exportable, Module, ModuleId, PositionalArg, Span, Spanned, SyntaxShape,
    Type,
};
...
pub fn parse_use(
    ...
    let (import_pattern, module) = if let Some(module_id) = import_pattern.head.id {
        ...
        match parse_module_file_or_dir(
            working_set,
            ...
            Ok(module_id) => {
                ...
                log::info!("=== SUBMODULES: {:?}", module.submodules);
